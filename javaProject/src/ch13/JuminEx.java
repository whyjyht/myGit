...
public class JuminEx {
	public static void main(String[] args) {
		...
		System.out.print("주민번호를 입력하세요 (-를 포함해서 입력) : ");
		jumin = scan.next();
		scan.close();
		...
		case "03": case "04": case "05": season = "겨울"; break;
		case "06": case "07": case "08": season = "겨울"; break;
		case "09": case "10": case "11": season = "겨울"; break;
		}
